...
<div class="app">
    <div class="app-login">
        <div class="text-center box shadow-5 animated fadeInLeft b-r-4 p-a-20">
            ...
            <form class="form-horizontal login_form" method="POST" action="{{ route('login') }}" >
                {{ csrf_field() }}

                <div class="form-group has-feedback text_input">
                    <input id="email" placeholder="نام کاربری" type="text" class="form-control" name="email" value="{{ old('email') }}" required autofocus>

                    @if ($errors->has('email'))
                        <span class="help-block">
                                        <strong>@lang('backend.error_mail')</strong>
                                    </span>
                    @endif
              ...
              <i class="fa fa-fw fa-user"></i>
                ...
                <div class="form-group has-feedback text_input">
                    <input id="password" placeholder="@lang('backend.password')" type="password" class="form-control " name="password" required>
              ...
              <i class="fa fa-fw fa-key"></i>
                ...
                <button type="submit" class="btn btn-primary btn-block m-b-15">@lang('backend.login')</button>
<!--
                <p class="text-left">
                    <a href="#">
                        <small>@lang('backend.forgetpassword')</small>
                    </a>
                </p>
-->
                <!--<p class="text-muted text-right">-->
                <!--    @lang('backend.asq_register_leter')-->
                <!--    <a href="{{ route('register') }}">@lang('backend.req_register')</a>-->
                <!--</p>-->
            </form>
