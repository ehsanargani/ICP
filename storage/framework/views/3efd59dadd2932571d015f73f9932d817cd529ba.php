...
-->
            ...
            <div class="box-body canvas-container overflow-hidden" style="min-height: 500px">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(url('/editteachermanagement')); ?>" onclick="event.preventDefault();document.getElementById('edit-form<?php echo e($notify->id); ?>').submit();" class="fa fa-fw fa-edit"></a>
                                    <form id="edit-form<?php echo e($notify->id); ?>" action="<?php echo e(url('/edit_notification')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>

                                        <input type="hidden" name="notify_id" value="<?php echo e($notify->id); ?>">
                                    </form>
                                </td>
                                <td class="text-center">

                                    <a href="<?php echo e(url('/editteachermanagement')); ?>" onclick="event.preventDefault();document.getElementById('del_user<?php echo e($notify->id); ?>').submit();" class="fa fa-times"></a>
                                    <form id="del_user<?php echo e($notify->id); ?>" action="<?php echo e(url('/del_notification')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>
                ...
                <!-- begin box-tools -->
                <div class="box-tools">
                    <a href="<?php echo e(url('add_notification')); ?>" class="btn btn-info0" style="color: #fff"><?php echo app('translator')->getFromJson('backend.add'); ?></a>
