                        ...
                        <ul class="nav navbar-header-nav m-l-a">
                            ...
                            <li class="dropdown b-l">
                                ...
                                <a class="dropdown-toggle profile-pic" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img class="img-circle" src="images/user/<?php echo e(Auth::user()->pic); ?>" alt="Jane Doe">
                                    <b class="hidden-xs hidden-sm"> <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->lastname); ?> </b>
                                </a>
                                <?php endif; ?>
                                <ul class="dropdown-menu animated flipInY pull-right">
<!--
                                    <li>
                                        <a href="<?php echo e(url('/profile_index')); ?>"><?php echo app('translator')->getFromJson('backend.profile'); ?></a>
                                    </li>
-->
                                    <li>
                                        <a href="<?php echo e(url('/password_index')); ?>"><?php echo app('translator')->getFromJson('backend.chengpassword'); ?></a>
                                    </li>

                                    <li role="separator" class="divider"></li>
                                    <li>
                                        <a href="<?php echo e(url('/logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <?php echo app('translator')->getFromJson('backend.exit'); ?>
                                        </a>
                                ...
                                <div class="side-content">
                                    ...
                                    <div class="user-panel">
                                        <div class="col-md-12 text-center img_user">
                                            <img src="images/user/<?php echo e(Auth::user()->pic); ?>" class="img-responsive">
                                        ...
                                        <ul class="metismenu nav nav-inverse nav-bordered nav-stacked" data-plugin="metismenu">
                                            ...
                                            <li>
                                                <a class="active" href="<?php echo e(url('/home')); ?>">
                                                    ...
                                                    <span class="nav-title"><?php echo app('translator')->getFromJson('backend.dashbord'); ?></span>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <ul class="nav nav-sub nav-stacked">
                                                    <li>
                                                        <a href="<?php echo e(url('/user')); ?>">مدیریت کاربران </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo e(url('/notification')); ?>"> مدیریت اطلاعیه ها </a>
                                                    </li>

                                                    <li>
                                                        <a href="<?php echo e(Url('/requlation')); ?>">مدیریت آیین نامه ها</a>
                                                    </li>

                                                    <li>
                                                        <a href="<?php echo e(url('/message')); ?>">مدیریت پیام ها</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <ul class="nav nav-sub nav-stacked">
                                                    <?php if(Auth::user()->role_id==1): ?>
                                                    <li>
                                                        <a href="<?php echo e(url('co_user_index')); ?>">کاربران شرکت</a>
                                                    ...
                                                    <li>
<!--                                                        <a href="<?php echo e(url('educationalplace')); ?>">درخواست های ارسال شده</a>-->
                                                    </li>
                                             ...
                                             <?php if(Auth::user()->role_id==1 || Auth::user()->role_id==2 ): ?>
                                              ...
                                              <li>
                                                <a class="" href="<?php echo e(url('/see_Certification')); ?>">
                                                    <span class="nav-icon">
                                                 ...
                                                 <?php endif; ?>
                                            <li>
                                                <a class="" href="<?php echo e(url('/regulation_home')); ?>">
                                                    <span class="nav-icon">
                                                        <i class="fa fa-file-text"></i>
                                                    </span>
                                             ...
                                             <?php if(Auth::user()->role_id==3): ?>
                                              <li>
                                                <a class="" href="<?php echo e(url('/add_Certification')); ?>">
                                                    <span class="nav-icon">
