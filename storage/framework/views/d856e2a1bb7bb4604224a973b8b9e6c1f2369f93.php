...
-->
            ...
            <div class="box-body canvas-container overflow-hidden" style="min-height: 500px">
                <div class="box-body collapse in" id="box3">
                    <table class="table table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td><?php echo e($user->co_name); ?></td>
                                <td><?php echo e($user->sh_num); ?></td>
                                <td><?php echo e($user->address); ?></td>
                                <td><?php echo e($user->Email); ?></td>
                                <td class="text-center">
                                    <a title="رمز عبور: 123456" href="<?php echo e(url('/editteachermanagement')); ?>" onclick="event.preventDefault();document.getElementById('reset<?php echo e($user->id); ?>').submit();" class="fa fa-refresh"></a>
                                    <form id="reset<?php echo e($user->id); ?>" action="<?php echo e(url('/co_pass')); ?>" method="POST" style="display: none;">
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/editteachermanagement')); ?>" onclick="event.preventDefault();document.getElementById('show<?php echo e($user->id); ?>').submit();" class="fa fa-eye"></a>
                                    <form id="show<?php echo e($user->id); ?>" action="<?php echo e(url('/show_co')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <form id="edit-form<?php echo e($user->id); ?>" action="<?php echo e(url('/edit_co')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <form id="del_user<?php echo e($user->id); ?>" action="<?php echo e(url('/del_co')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>
                ...
                <!-- begin box-tools -->
                <div class="box-tools">
                    <a href="<?php echo e(url('add_co')); ?>" class="btn btn-info0" style="color: #fff"><?php echo app('translator')->getFromJson('backend.add'); ?></a>
                </div>
                <!-- END: box-tools -->
